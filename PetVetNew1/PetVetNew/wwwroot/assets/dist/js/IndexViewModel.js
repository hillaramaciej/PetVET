    ...
    update: function (element, valueAccessor, allBindingsAccessor, viewModel) {
      ...
      $(element).fullCalendar({
        ...
        eventClick: function (calEvent, jsEvent, view) {
          ...
          // if(user === undefined)
          // vm.ReservationBeginEdited(ko.utils.unwrapObservable(new my.Rezervation(null, ko.observable(new my.User("d","",1)))));
          // else
          // vm.ReservationBeginEdited(ko.utils.unwrapObservable(new my.Rezervation(null, ko.observable(new my.User("f","",1)))));
  ...
  my.ViewModel = function (config) {
   ...
   // Save the changes back to the original instance in the collection.
    ...
    var dddd = ko.utils.unwrapObservable(vm.OrginalRezervation);
      ...
      var lastName = ko.utils.unwrapObservable(ko.utils.unwrapObservable(updatedUser.Test()));
